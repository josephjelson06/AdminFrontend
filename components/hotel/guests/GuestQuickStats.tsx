    ...
    return (
        <div className="grid grid-cols-4 gap-3 mb-6">
            <button
                ...
                className={`p-3 rounded-xl text-center transition-all ${activeFilter === 'all'
            ...
            <button
                ...
                className={`p-3 rounded-xl text-center transition-all ${activeFilter === 'verified'
            ...
            <button
                ...
                className={`p-3 rounded-xl text-center transition-all ${activeFilter === 'manual'
            ...
            <button
                ...
                className={`p-3 rounded-xl text-center transition-all ${activeFilter === 'failed'
