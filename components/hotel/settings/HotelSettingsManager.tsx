    ...
    return (
        <HotelLayout>
            ...
            <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div className="sm:col-span-2">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2.5 border border-slate-600 rounded-xl text-sm bg-slate-800/50 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2.5 border border-slate-600 rounded-xl text-sm bg-slate-800/50 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                                />
                            </div>
                        </div>
                ...
                {hasChanges && (
                    <div className="flex items-center justify-between p-4 bg-amber-500/10 rounded-xl border border-amber-500/20 animate-in slide-in-from-bottom duration-300 backdrop-blur-md">
                        <p className="text-sm text-amber-500 font-medium">
                            You have unsaved changes
                        </p>
                        <button
                            onClick={handleSave}
                            className="flex items-center gap-2 px-4 py-2 bg-amber-500 text-white text-sm font-medium rounded-lg hover:bg-amber-600 transition-colors shadow-lg shadow-amber-500/20"
                        >
                            <Save className="w-4 h-4" />
                            Save Now
                        </button>
