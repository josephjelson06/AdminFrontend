                    ...
                    <div className="mt-6 pt-6 border-t border-slate-200 dark:border-slate-700">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                            <button
                                ...
                                className="px-3 py-2 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 text-xs font-medium rounded-md hover:bg-indigo-100 dark:hover:bg-indigo-900/50 transition-colors"
                            >
                                Manager
                            </button>
                            <button
                                ...
                                className="px-3 py-2 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 text-xs font-medium rounded-md hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors"
                            >
                                Front Desk
                            </button>
                            <button
                                ...
                                className="px-3 py-2 bg-amber-50 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400 text-xs font-medium rounded-md hover:bg-amber-100 dark:hover:bg-amber-900/50 transition-colors"
                            >
                                Housekeeping
                            </button>
                            <button
                                ...
                                className="px-3 py-2 bg-emerald-50 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 text-xs font-medium rounded-md hover:bg-emerald-100 dark:hover:bg-emerald-900/50 transition-colors"
                            >
                                Finance
                            </button>
                            <button
                                type="button"
                                onClick={() => { setEmail('maintenance@hotel.in'); setPassword('maintenance123'); }}
                                className="px-3 py-2 bg-orange-50 dark:bg-orange-900/30 text-orange-700 dark:text-orange-400 text-xs font-medium rounded-md hover:bg-orange-100 dark:hover:bg-orange-900/50 transition-colors col-span-2 sm:col-span-1"
                            >
                                Maintenance
                            </button>
                        </div>
