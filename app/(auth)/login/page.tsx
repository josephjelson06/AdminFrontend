            ...
            <div className="w-full max-w-md relative px-4 sm:px-0">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-6 sm:p-8">
                    ...
                    <div className="mt-4 pt-4 border-t border-slate-200 dark:border-slate-700">
                        <p className="text-xs text-slate-500 dark:text-slate-400 text-center mb-3">Hotel Panel</p>
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                            ...
                            <button
                                type="button"
                                onClick={() => { setEmail('housekeeping@hotel.in'); setPassword('housekeeping123'); }}
